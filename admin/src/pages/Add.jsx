       ...
       <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
            ...
            <div>
             ...
             <div>
              ...
              <input className='w-full px-3 py-2 sm:w-[120px]' type="number" placeholder='500' />
             </div>
           ...
           <div>
            ...
            <div className='flex gap-2 mt-2'>
              ...
              <label className='cursor-pointer' htmlFor="Bestseller">Add to Bestseller</label>
                      ...
                      <button
            type="submit"
            className="w-32 py-2.5 bg-black text-white font-medium rounded-xl shadow-md hover:bg-gray-800 hover:shadow-lg transition-all duration-300"
          >
            ADD
          </button>
